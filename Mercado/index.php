            ...
            <header id="dock">
                ...
                <main>
                    <div class="box comprar">
                        <a href="mercadocompra.php">
                            <h2>Comprar</h2>
                            <img src="../Design/Icons/Mercado/Buy_icon.png" alt="Buy_icon">
                        </a>
                    </div>
                    <div class="box vender">
                        <a href="mercadovenda.php">
                            <h2>Vender</h2>
                            <img src="../Design/Icons/Mercado/Sell_icon.png" alt="Sell_icon">   
                        </a>
                    </div>
                </main>
    </body>
